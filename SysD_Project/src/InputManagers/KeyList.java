...
public enum KeyList {
    ...
    O("O", KeyStroke.getKeyStroke(KeyEvent.VK_O, 0)),
    Orelease("released O", KeyStroke.getKeyStroke(KeyEvent.VK_O, 0, true)),
    L("L", KeyStroke.getKeyStroke(KeyEvent.VK_L, 0)),
    Lrelease("released L", KeyStroke.getKeyStroke(KeyEvent.VK_L, 0, true)),
    ;
